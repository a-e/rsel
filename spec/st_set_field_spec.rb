...
describe "#set_field" do
    ...
    context "#set_field with #type_into_field" do
      context "passes when" do
        context "text field with label" do
          it "exists" do
            @st.set_field("First name", "Eric").should be true
            @st.set_field("Last name", "Pierce").should be true
            @st.field_contains("First name", "Eric").should be true
            @st.field_contains("Last name", "Pierce").should be true
          end
          it "exists within scope" do
            @st.set_field("First name", "Eric", :within => 'person_form').should be true
            @st.set_field("First name", "Andrea", :within => 'spouse_form').should be true
          end
        end

        context "text field with id" do
          it "exists" do
            @st.set_field("first_name", "Eric").should be true
            @st.set_field("last_name", "Pierce").should be true
            @st.field_contains("first_name", "Eric").should be true
            @st.field_contains("last_name", "Pierce").should be true
          end
        end

        context "textarea with label" do
          it "exists" do
            @st.set_field("Life story", "Blah blah blah").should be true
            @st.set_field("Life story", "Jibber jabber").should be true
            @st.field_contains("Life story", "Jibber jabber").should be true
          end
        end

        context "textarea with id" do
          it "exists" do
            @st.set_field("biography", "Blah blah blah").should be true
            @st.set_field("biography", "Jibber jabber").should be true
            @st.field_contains("biography", "Jibber jabber").should be true
          end
        end

        context "text field with name but duplicate id" do
          it "exists" do
            @st.set_field("second_duplicate", "Jibber jabber").should be true
            @st.field_contains("first_duplicate", "").should be true
            @st.field_contains("second_duplicate", "Jibber jabber").should be true
          end
        end

        it "clears a field" do
          @st.field_contains("message", "Your message goes here").should be true
          @st.set_field("message","").should be true
      ...
      context "fails when" do
        it "no field with the given label or id exists" do
          @st.set_field("Middle name", "Matthew").should be false
          @st.set_field("middle_name", "Matthew").should be false
        end
        ...
        it "field exists, but is read-only" do
          ...
          @st.set_field("First name", "Eric").should be false
        end
        ...
        it "field exists but is hidden" do
          #pending "selenium-client thinks hidden fields are editable" do
            ...
            @st.set_field("secret", "whisper").should be false
          #end
        end
      end
      ...
      context "passes when" do
        context "text field with label" do
          it "equals the text" do
            ...
            @st.generic_field_equals("First name", "Ken").should be true
          end
        ...
        context "textarea with label" do
          it "equals the text" do
            @st.set_field("Life story", "Blah dee blah")
            @st.generic_field_equals("Life story", "Blah dee blah").should be true
          end
      ...
      context "fails when" do
        context "text field with label" do
          it "does not exactly equal the text" do
            @st.set_field("First name", "Marcus")
            @st.generic_field_equals("First name", "Marc").should be false
          end
        end
        ...
        context "text field with id" do
          it "exactly equals the text, but is an unsupported type" do
            #pending "hidden fields should be unsupported" do
              ...
              @st.generic_field_equals("secret", "psst").should be false
            #end
          end
        end
        ...
        context "textarea with label" do
          it "does not exist" do
            @st.generic_field_equals("Third name", "Smith").should be false
          end

          it "does not exactly equal the text" do
            @st.set_field("Life story", "Blah dee blah")
            @st.generic_field_equals("Life story", "Blah dee").should be false
          end

          it "exactly equals the text, but is not within scope" do
            @st.set_field("First name", "Eric", :within => "person_form")
            @st.generic_field_equals("First name", "Eric", :within => "spouse_form").should be false
          end
  ...
  context "checkboxes" do
    ...
    context "#set_field with #enable_checkbox" do
      context "passes when" do
        context "checkbox with label" do
          it "exists" do
            @st.set_field("I like cheese", "on").should be true
            @st.set_field("I like salami", "on").should be true
            @st.generic_field_equals("I like cheese", "on").should be true
            @st.generic_field_equals("I like salami", "on").should be true
          end
          ...
          it "exists within scope" do
            @st.set_field("I like cheese", "on", :within => "cheese_checkbox").should be true
            @st.set_field("I like salami", "on", :within => "salami_checkbox").should be true
            @st.generic_field_equals("I like cheese", "on", :within => "cheese_checkbox").should be true
            @st.generic_field_equals("I like salami", "on", :within => "salami_checkbox").should be true
          end

          it "exists in table row" do
            @st.visit("/table")
            @st.set_field("Like", "on", :in_row => "Marcus").should be true
            @st.generic_field_equals("Like", "on", :in_row => "Marcus").should be true
          end
        end

        context "checkbox with id=" do
          it "exists" do
            @st.set_field("id=like_cheese", "on").should be true
            @st.generic_field_equals("id=like_cheese", "on").should be true
          end
        end

        context "checkbox with xpath=" do
          it "exists" do
            @st.set_field("xpath=//input[@id='like_cheese']", "on").should be true
            @st.generic_field_equals("xpath=//input[@id='like_cheese']", "on").should be true
          end
        end
      end
      ...
      context "fails when" do
        context "checkbox with label" do
          it "does not exist" do
            @st.set_field("I dislike bacon", "on").should be false
            @st.set_field("I like broccoli", "on").should be false
          end

          it "exists, but not within scope" do
            @st.set_field("I like cheese", "on", :within => "salami_checkbox").should be false
            @st.set_field("I like salami", "on", :within => "cheese_checkbox").should be false
          end

          it "exists, but not in table row" do
            @st.visit("/table")
            @st.set_field("Like", "on", :in_row => "Eric").should be false
          end

          it "exists, but is read-only" do
            @st.visit("/readonly_form").should be true
            @st.set_field("I like salami", "on").should be false
          end
        end
      end
    ...
    context "#set_field with #disable_checkbox" do
      context "passes when" do
        context "checkbox with label" do
          it "exists" do
            @st.set_field("I like cheese", "off").should be true
            @st.set_field("I like salami", "off").should be true
            @st.generic_field_equals("I like cheese", "off").should be true
            @st.generic_field_equals("I like salami", "off").should be true
          end
          ...
          it "exists within scope" do
            @st.set_field("I like cheese", "off", :within => "cheese_checkbox").should be true
            @st.set_field("I like salami", "off", :within => "preferences_form").should be true
            @st.generic_field_equals("I like cheese", "off", :within => "cheese_checkbox").should be true
            @st.generic_field_equals("I like salami", "off", :within => "preferences_form").should be true
          end

          it "exists in table row" do
            @st.visit("/table")
            @st.set_field("Like", "off", :in_row => "Marcus").should be true
            @st.generic_field_equals("Like", "off", :in_row => "Marcus").should be true
          end
        end

        context "checkbox with id=" do
          it "exists" do
            @st.set_field("id=like_cheese", "off").should be true
            @st.generic_field_equals("id=like_cheese", "off").should be true
          end
        end

        context "checkbox with xpath=" do
          it "exists" do
            @st.set_field("xpath=//input[@id='like_cheese']", "off").should be true
            @st.generic_field_equals("xpath=//input[@id='like_cheese']", "off").should be true
          end
        end
      end
      ...
      context "fails when" do
        context "checkbox with label" do
          it "does not exist" do
            @st.set_field("I dislike bacon", "off").should be false
            @st.set_field("I like broccoli", "off").should be false
          end

          it "exists, but not within scope" do
            @st.set_field("I like cheese", "off", :within => "salami_checkbox").should be false
            @st.set_field("I like salami", "off", :within => "cheese_checkbox").should be false
          end

          it "exists, but not in table row" do
            @st.visit("/table")
            @st.set_field("Like", "off", :in_row => "Eric").should be false
          end

          it "exists, but is read-only" do
            @st.visit("/readonly_form").should be true
            @st.set_field("I like cheese", "off").should be false
          end
        end
      end
      ...
      context "passes when" do
        context "checkbox with label" do
          ...
          it "exists in table row and is checked" do
            @st.visit("/table")
            @st.set_field("Like", "on", :in_row => "Ken").should be true
      ...
      context "passes when" do
        context "checkbox with label" do
          ...
          it "exists in table row and is unchecked" do
            @st.visit("/table")
            @st.set_field("Like", "off", :in_row => "Ken").should be true
  ...
  context "radiobuttons" do
    ...
    context "#set_field with #select_radio" do
      context "passes when" do
        context "radiobutton with label" do
          it "exists" do
            @st.set_field("Briefs").should be true
          end

          it "exists within scope" do
            @st.set_field("Briefs", "", :within => "clothing").should be true
          end
      ...
      context "fails when" do
        context "radiobutton with label" do
          it "does not exist" do
            @st.set_field("Naked", "").should be false
          end

          it "exists, but not within scope" do
            @st.set_field("Briefs", "", :within => "food").should be false
          end

          it "exists, but is read-only" do
            @st.visit("/readonly_form").should be true
            @st.set_field("Boxers", "").should be false
          end
    ...
    context "#set_field with #generic_field_equals for #radio_is_enabled" do
      context "passes when" do
        context "radiobutton with label" do
          it "exists, and is enabled" do
            @st.set_field("Briefs")
            @st.generic_field_equals("Briefs", "on").should be true
          end

          it "exists within scope, and is enabled" do
            @st.set_field("Briefs", "", :within => "clothing")
            @st.generic_field_equals("Briefs", "on", :within => "clothing").should be true
          end
      ...
      context "fails when" do
        context "radiobutton with label" do
          it "does not exist" do
            @st.generic_field_equals("Naked", "on").should be false
          end

          it "exists, but is not enabled" do
            @st.set_field("Briefs", "")
            @st.generic_field_equals("Boxers", "on").should be false
          end

          it "exists and is enabled, but not within scope" do
            @st.set_field("Briefs", "", :within => "clothing")
            @st.generic_field_equals("Briefs", "on", :within => "food").should be false
          end
        end
      end
    ...
    context "#set_field with #generic_field_equals for #radio_is_disabled" do
      context "passes when" do
        context "radiobutton with label" do
          it "exists, and is disabled" do
            @st.set_field("Boxers")
            @st.generic_field_equals("Briefs", "off").should be true
          end

          it "exists within scope, and is disabled" do
            @st.set_field("Boxers", "", :within => "clothing")
            @st.generic_field_equals("Briefs", "off", :within => "clothing").should be true
          end
      ...
      context "fails when" do
        context "radiobutton with label" do
          it "does not exist" do
            @st.generic_field_equals("Naked", "off").should be false
          end

          it "exists, but is enabled" do
            @st.set_field("Briefs", "")
            @st.generic_field_equals("Briefs", "off").should be false
          end

          it "exists and is disabled, but not within scope" do
            @st.set_field("Boxers", "", :within => "clothing")
            @st.generic_field_equals("Briefs", "off", :within => "food").should be false
          end
        end
      end
    ...
    context "#set_field with #select_from_dropdown" do
      context "passes when" do
        it "option exists in the dropdown" do
          @st.set_field("Height", "Tall").should be true
          @st.set_field("Weight", "Medium").should be true
        end

        it "option exists in the dropdown within scope" do
          @st.set_field("Height", "Tall", :within => "spouse_form").should be true
        end

        it "option exists in the dropdown in table row" do
          @st.visit("/table")
          @st.set_field("Gender", "Male", :in_row => "Eric").should be true
        end
      end

      context "fails when" do
        it "no such dropdown exists" do
          @st.set_field("Eggs", "Over easy").should be false
        end

        it "dropdown exists, but the option doesn't" do
          @st.set_field("Height", "Giant").should be false
          @st.set_field("Weight", "Obese").should be false
        end

        it "dropdown exists, but is read-only" do
          @st.visit("/readonly_form").should be true
          @st.set_field("Height", "Tall").should be false
        end

        it "dropdown exists, but not within scope" do
          @st.set_field("Weight", "Medium", :within => "spouse_form").should be false
        end

        it "dropdown exists, but not in table row" do
          @st.visit("/table")
          @st.set_field("Gender", "Female", :in_row => "First name").should be false
        end
      end
    ...
    context "#set_field with #generic_field_equals for #dropdown_equals" do
      context "passes when" do
        it "option is selected in the dropdown" do
          ["Short", "Average", "Tall"].each do |height|
            @st.set_field("Height", height)
            @st.generic_field_equals("Height", height).should be true
          end
        end

        it "option is selected in a read-only dropdown" do
          @st.visit("/readonly_form").should be true
          @st.generic_field_equals("Height", "Average").should be true
        end

        it "option is selected in the dropdown, within scope" do
          ["Short", "Average", "Tall"].each do |height|
            @st.set_field("Height", height, :within => "spouse_form")
            @st.generic_field_equals("Height", height, :within => "spouse_form").should be true
          end
        end
        ...
        it "option is selected in the dropdown, in table row" do
          @st.visit("/table")
          ["Male", "Female"].each do |gender|
            @st.set_field("Gender", gender, :in_row => "Eric").should be true
      ...
      context "fails when" do
        it "no such dropdown exists" do
          @st.generic_field_equals("Eggs", "Over easy").should be false
        end

        it "dropdown exists, but the option is not selected" do
          @st.set_field("Height", "Short")
          @st.generic_field_equals("Height", "Average").should be false
          @st.generic_field_equals("Height", "Tall").should be false

          @st.set_field("Height", "Average")
          @st.generic_field_equals("Height", "Short").should be false
          @st.generic_field_equals("Height", "Tall").should be false
        ...
        it "dropdown exists, and option is selected, but not within scope" do
          @st.set_field("Height", "Tall", :within => "person_form").should be true
          @st.set_field("Height", "Short", :within => "spouse_form").should be true
          @st.generic_field_equals("Height", "Tall", :within => "spouse_form").should be false
        end

        it "dropdown exists, and option is selected, but not in table row" do
          @st.visit("/table")
          @st.set_field("Gender", "Female", :in_row => "Eric").should be true
          @st.set_field("Gender", "Male", :in_row => "Marcus").should be true
          @st.generic_field_equals("Gender", "Female", :in_row => "Marcus").should be false
        end
      end
  ...
  context "#set_field with button click" do
    ...
    it "clicks a button" do
      @st.set_field("Submit person form", "clicked").should be true
      @st.page_loads_in_seconds_or_less(10).should be true
      @st.see("We appreciate your feedback").should be true
    end
  end
  ...
  context "#set_field with link click" do
    ...
    it "clicks a link" do
      @st.set_field("About this site", "clicked").should be true
      @st.page_loads_in_seconds_or_less(10).should be true
      @st.see("This site is really cool.").should be true
    end
  end
